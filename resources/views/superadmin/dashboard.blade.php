                    ...
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                ...
                                <h6 class="font-extrabold mb-0">{{ $data['total_admin'] }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                ...
                                <h6 class="font-extrabold mb-0">{{ $data['total_buku_wajib'] + $data['total_buku_non_wajib'] }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted">Peminjaman Terlambat</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-info rounded-pill">{{ date('d/m/Y') }}</span>
                    </div>
                </div>
            </div>
        </div>
