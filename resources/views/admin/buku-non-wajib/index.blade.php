...
@section('title', 'Manajemen Buku Non-Wajib - SmartLib')
@section('page-title', 'Manajemen Buku Non-Wajib')
...
@section('content')
        ...
        <div class="col-md-8">
            <div class="d-flex gap-2">
                <a href="{{ route('admin.buku-non-wajib.create') }}" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-2"></i>Tambah Buku Non-Wajib
                </a>
    ...
    <div class="chart-card">
        <div class="chart-header">
            <h5 class="chart-title">Daftar Buku Non-Wajib</h5>
            <span class="badge primary">{{ $bukuNonWajib->total() }} buku</span>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    @forelse($bukuNonWajib as $index => $buku)
                        <tr>
                            <td>{{ $bukuNonWajib->firstItem() + $index }}</td>
                            <td>
                            ...
                            <td>{{ $buku->penulis ?? '-' }}</td>
                            <td>
                                <span class="badge success">{{ $buku->kategori->nama ?? '-' }}</span>
                            </td>
                            <td>{{ $buku->penerbit ?? '-' }}</td>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('admin.buku-non-wajib.show', $buku) }}">
                                                <i class="bi bi-eye me-2"></i>Detail
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('admin.buku-non-wajib.edit', $buku) }}">
                                        ...
                                        <li>
                                            <form method="POST"
                                                action="{{ route('admin.buku-non-wajib.destroy', $buku) }}"
                        ...
                        <tr>
                            <td colspan="9" class="text-center py-4">
                                <div class="text-muted">
                                    ...
                                    Tidak ada buku non-wajib ditemukan
                                </div>
                            </td>
                        </tr>
                    @endforelse
